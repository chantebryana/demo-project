...
<html>
    <head>
		...
		<meta http-equiv="refresh" content="1;URL=violinList.php">
	</head>
	<body>
	<?php
	...
	echo ("Assimilating form data into brain banks. If page doesn't automatically redirect in 1 second click " . "<a href = \"violinList.php\">here</a>" . ".");

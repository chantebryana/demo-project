...
<html>
	...
	$insertString = "INSERT INTO dates_and_times VALUES (\"$param1\", \"$param2\")"; 
	$queryInput = mysql_query($insertString) or die("Query failed: " . mysql_error());
	
	//echo ("<a href = \"test.php\">Back to Homepage</a>");
	echo ("Assimilating form data into brain banks. If page doesn't automatically redirect in 3 seconds click " . "<a href = \"test.php\">here</a>" . ".");
